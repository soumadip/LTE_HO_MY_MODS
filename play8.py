...
for exp in expt :
    ...
    for i in index :
        if exp in ["1a", "2a"] :
            fname = ues_str + "_" + bt + "_" + exp + "_" + i + "_none_jula_a10.0_b" + bt + "_g" + str (gamma) + "_p1_u" + ues_str + ".connection"
            fname_debug = ues_str + "_" + bt + "_" + exp + "_" + i + "_none_jula_a10.0_b" + bt + "_g" + str (gamma) + "_p1_u" + ues_str + ".debug"
            dname = "/home/external/Python-Data-Processing/paris-t1-randSel/" + ues_str +"_" + bt + "_" + exp + "_" + i + "_none_jula_a10.0_b" + bt + "_g" + str (gamma) + "_p1_u" + ues_str +"/" + "NOV/"
            ...
            dname = "/home/external/Python-Data-Processing/paris-t1-randSel/" + ues_str + "_" + exp + "_" + bt + "_" + i + "_a3_" + exp + "_a0_b" + bt + "_g0_p1_u" + ues_str + "/" + "V4/"
        elif exp in ["ussl-a"]:
            fname = ues_str + "_" + exp + "_" + bt + "_" + i + "_" + exp + "_none_a0.0_b" + bt + "_g0_p1_u" + ues_str + ".connection"
            fname_debug = ues_str + "_" + exp + "_" + bt + "_" + i + "_" + exp + "_none_a0.0_b" + bt + "_g0_p1_u" + ues_str + ".debug"
            dname = "/home/external/Python-Data-Processing/paris-t1-randSel/" + ues_str + "_" + exp + "_" + bt + "_" + i + "_" + exp + "_none_a0.0_b" + bt + "_g0_p1_u" + ues_str + "/" + "V4/"
        ...
        for e in enb_load_per_time :
            ...
            f_avg_load [exp] [e] += sum (enb_load_per_time [e] .values ())/ 150
...
ax3 .bar ([used_enb_index [e] for e in sorted (f_avg_load [exp] .keys ())], [f_avg_load [exp] [e] for e in sorted (f_avg_load [exp] .keys ())], label = names [exp], width=.8, color = "grey")
#ax3 .set_ylim ([0, 65])
